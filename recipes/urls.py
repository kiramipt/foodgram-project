...
urlpatterns = [
    ...
    path('purchases/download/', views.purchases_download, name='purchases_download'),
    ...
    # path('purchases/delete/<int:recipe_id>', views.purchases_delete, name='purchases_delete'),
]
